...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.demo-devops.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".demo-devops" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".demo-devops")
	}
